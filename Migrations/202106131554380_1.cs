namespace ProjectApp.Migrations
{
    ...
    public partial class _1 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Favorites", "UserProductID", "dbo.UserProducts");
            ...
            DropForeignKey("dbo.KeywordCategories", "CategoryID", "dbo.Categories");
            ...
            DropIndex("dbo.Favorites", new[] { "UserProductID" });
            DropIndex("dbo.KeywordCategories", new[] { "Keyword_ID" });
            DropIndex("dbo.KeywordCategories", new[] { "CategoryID" });
